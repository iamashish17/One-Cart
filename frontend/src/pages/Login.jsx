...
function Login() {
  ...
  <div className="w-full h-screen bg-gradient-to-l from-[#141414] to-[#0c2025] flex flex-col items-center justify-start">
    ...
    <form action="" onSubmit={handleLogin} className='w-full flex flex-col items-center justify-center gap-[20px]'>
      ...
      <button className='w-[70%] h-[50px] bg-[#6060f5] rounded-lg flex items-center justify-center mx-[20px] text-[17px] font-semibold hover:bg-[#4a4ae0]'>Login</button>
      <p className="flex gap-[10px] p-[5px]">You have no account?<span className="text-[#5555f6cf] text-[17px] font-semibold cursor-pointer hover:text-blue-400" onClick={() => navigate("/signup")}>New Registration</span></p>
    </form>
    </div>
  </div>
  )
